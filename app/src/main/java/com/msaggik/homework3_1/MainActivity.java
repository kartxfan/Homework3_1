package com.msaggik.homework3_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState){
        ...
        outState.putInt("key", count); // запись необходимых данных к контейнеру Bundle

        // размещаем вспомогательный тост
        Toast toast = Toast.makeText(this, "Запись данных в контейнер Bundle", Toast.LENGTH_SHORT); // инициализация
        toast.show(); // демонстрация тоста на экран
    }

    @Override
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState){
        super.onRestoreInstanceState(savedInstanceState);
        count = savedInstanceState.getInt("key"); // возврат данных из контейнера Bundle
